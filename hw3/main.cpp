...
int main(int argc, char* argv[]) {
    ...
    if (argc == 1) {
        ...
        //StudentTestsTwo();
        std::cout << "Student tests two completed." << std::endl;    
        ExtraCreditTests();
    } else {
        if (argc != 3) {
...
void SimpleTest() {
    ...
    // test table combination in rows
    // t.push_back_row(another);
    //t.push_back_column(another);
    // t.print();
...
void StudentTests() {
    ...
    new_row2.push_back(11);
    new_row2.push_back(12);
    new_row2.push_back(13);
    new_row2.push_back(14);
    new_row2.push_back(15);
    another.push_back_row(new_row2);
    assert (t.numRows()+1 == another.numRows());
    assert (t.numColumns() == another.numColumns());
    t.print();
