...
*/
    ...
    */
    ...
    cout << endl;
    int y;
    std::cout << "Please type in the number you want to remove: " << std::endl;
    std::cin >> y;
    std::cout << "The number of elements you remove is: ";
        std::cout <<remove_matching_elements(test2, y) << std::endl;
    test2.print();
    std::cout << std::endl;
    ...
    std::cin >> x;
    std::cout << "The number of elements you remove is: ";
    std::cout << remove_matching_elements(t1, x) << std::endl;
    t1.print();
    std::cout << std::endl;
